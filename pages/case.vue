<template>
  <div>
    ...
    <h2>This is a H2</h2>
    <p>
      A web-native Blockchain eradicates the need to download anything, to register anywhere and - most importantly - to understand how it works to be able to use it:
    </p>
    <blockquote>
