<template>
  <div>
    ...
    <p>
      ...
      10965 Berlin<br>
      Deutschland<br>
      Phone: 030 640 803 38<br>
      Email: <a href="mailto:hello@overnice.com">hello@overnice.com</a><br>
      Website: <a href="https://www.overnice.com">www.overnice.com</a>
    </p>
    <h2>3. Cookies</h2>
    <p>
    ...
    <h2>8. Data protection provisions about the application and use of Google Analytics (with anonymization function)</h2>
    <p>
    ...
    <p>
      This Privacy Policy has been generated by the Privacy Policy Generator of the <a target="_blank" href="https://dg-datenschutz.de/services/external-data-protection-officer/?lang=en">DGD - Your External DPO</a> that was developed in cooperation with <a target="_blank" href="https://www.wbs-law.de/eng/">German Lawyers</a> from WILDE BEUGER SOLMECKE, Cologne.
    </p>
  </div>
</template>
